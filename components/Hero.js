...
export default function Hero() {
  return (
    <section
    id="paginainicial"
    className="max-w-[1320px] mx-auto px-4 pt-14 text-center lg:overflow-hidden"
  >
    <h1 className="text-5xl font-bold tracking-[-0.02em] lg:text-[4.4rem] lg:max-w-[1100px] lg:mx-auto lg:mb-8 lg:leading-none"
    >Descubra uma câmera que entende o que você precisa!
    </h1>

    <p className="text-[1.1rem] font-bold text-texto max-w-[600px] mx-auto mb-6">
      Através da câmera, suas fotos de textos são organizadas por assunto na galeria e podem ser transformadas em PDFs.
    </p>
