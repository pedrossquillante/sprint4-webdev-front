      ...
      <div className="max-w-[1320px] mx-auto px-4">
        <nav className="lg:flex lg:justify-center lg:items-center lg:relative lg:bg-fundo-secundaria lg:rounded-full lg:py-3 lg:px-8 lg:shadow-[0_2px_8px_rgba(0,0,0,0.08)]">
          ...
          <ul 
            ...
            >
            <li>
              <a href="#paginainicial" onClick={fecharMenu} className={linkClasses}>
                Página Inicial
              </a>
            </li>
            <li>
              <a href="#publicoalvo" onClick={fecharMenu} className={linkClasses}>
                Público-alvo
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#nossaequipe" onClick={fecharMenu} className={linkClasses}>
                Nossa equipe
              </a>
            </li>
            <li>
